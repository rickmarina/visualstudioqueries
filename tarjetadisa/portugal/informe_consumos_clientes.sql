SELECT to_char(movimiento_mov.mov_fecha,'YYYYMMDD') AS FECHA,  
        ...
        right(comercio_com.com_id_ext,4) AS codestacion, 
...
AND left(tarjeta_crd.crd_pan,6) = '972428' 
GROUP BY right(comercio_com.com_id_ext,4), comercio_com.nombre, to_char(movimiento_mov.mov_fecha,'YYYYMMDD'), 
productos_bandera_pba.prg_descripcion, cliente_cli.cli_id_ext, 3, provincia_prov.prov_nombre				